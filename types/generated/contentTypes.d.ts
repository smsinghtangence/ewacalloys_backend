...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::blog.blog'> &
      Schema.Attribute.Private;
    MetaSection: Schema.Attribute.Component<'meta-section.meta-section', true>;
    publishedAt: Schema.Attribute.DateTime;
    Slider: Schema.Attribute.Component<'slider.slider', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiContactSubmissionContactSubmission
  ...
  info: {
    description: "Messages submitted through the website's Contact Us form";
...
export interface ApiRedirectRedirect extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    RedirectType: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiSecuritySettingsSecuritySettings
  extends Struct.SingleTypeSchema {
  collectionName: 'security_settings';
  info: {
    description: 'Settings for frontend security headers';
    displayName: 'Security Settings';
    pluralName: 'security-settings-items';
  ...
  attributes: {
    contentSecurityPolicy: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<"default-src 'self'; img-src 'self' data:; style-src 'self' 'unsafe-inline'; script-src 'self' 'unsafe-inline'; object-src 'none'; base-uri 'self'; frame-ancestors 'none'">;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    permissionsPolicy: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'camera=(), microphone=(), geolocation=()'>;
    publishedAt: Schema.Attribute.DateTime;
    referrerPolicy: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'strict-origin-when-cross-origin'>;
    strictTransportSecurity: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'max-age=31536000; includeSubDomains'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    xContentTypeOptions: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'nosniff'>;
    xFrameOptions: Schema.Attribute.String & Schema.Attribute.DefaultTo<'DENY'>;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::security-settings.security-settings': ApiSecuritySettingsSecuritySettings;
